...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:include href="searchform_advanced_geodata.xsl"/>
	...
	<xsl:template mode="script" match="/">
		...
		<script type="text/javascript">
			...
			Ext.onReady(function(){
              ...
              contentEl: 'advanced_geodata_search_pnl'
              }
	...
	<xsl:template name="content">
      ...
      <div id="advanced_geodata_search_pnl" class="x-hide-display" title="{/root/gui/strings/advancedSearch}">
        <xsl:call-template name="advanced_geodata_search_panel" />
      </div>
